...
handleJstreeCheckable=function(){
		$("#jstree-checkable").jstree({
				...
				state:{selected:!0}},{text:"Folder 1"},
				{text:"Folder 2"},
				{text:"Folder 3"},
				{text:"initially open",icon:"fa fa-folder fa-lg",state:{opened:!0},children:[{text:"Another node"},
