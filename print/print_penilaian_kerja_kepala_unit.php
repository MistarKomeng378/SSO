	...
	$jab 		= mysql_fetch_array(mysql_query("select * from m_jabatan where poscode = '".$kar['poscode']."'"));
		...
		<table width="100%" border="0" cellpadding="3">
			...
			<tr>
				<td width="100%" align="center">
					<b>
						<font size="12"><u>REPORT PENILAIAN SASARAN KERJA KEPALA UNIT</u></font><br>
		...
		<table width="100%" border="0">		
			<tr>
				...
				<td width="2%">:</td>
				<td width="35%">'.$getNik.'</td>
			</tr>
			<tr>
				<td width="13%"><b>Nama</b></td>
				<td width="2%">:</td>
				<td width="35%">'.name($getNik).'</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="2%">:</td>
				<td width="35%"><font size="12"><b>'.desimal3($jumlah_total_nilai22).'</b></font></td>
			</tr>
		</table>
		<br>
		...
		<table width="100%" border="1" cellpadding="3">
			...
			///====================== Baris Isi =======================///
				...
				<tr bgcolor="'.$bgcolor.'">
					...
					<td width="6%" align="center">'.$bot_kep_unit.'</td>
		...
		<font size="8"> Keterangan : <br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
					<b>Bobot Kepala Unit diambil dari Bobot SRKO yang selanjutnya dikonversikan secara otomatis menjadi 75</b> </font>
		<br>
		<br>
		<br>
