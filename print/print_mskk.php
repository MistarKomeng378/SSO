...
set_time_limit(0);
	...
	$tahun		= mysql_real_escape_string(dc($getId[2]));
	timeline($_SESSION['nik'],"download","Telah melakukan download MSKK ".name($getNik)." Bulan ".bulan($getBulan)." Tahun $tahun");
	...
	$query = mysql_query("SELECT	mskk.*,
									...
									WHERE mskk.nik='$getNik' AND mskk.bulan='$getBulan' AND mskk.tahun='$tahun'
	...
	$isi ='
			...
			<tr>
				...
				<td width="40%" align="center">
					<b>
						...
						BULAN : '.STRTOUPPER(bulan($getBulan)).' - TAHUN : '.$tahun.'
					</b>
				</td>
				<td width="30%"></td>
			</tr>
		...
		if($_GET['lvl']==4){
			$isi .='<th width="3%" ><b>No.</b></th>
					...
					<th width="8%"><b>Bobot Konversi</b></th>
	...
	<table width="100%" border="1" cellpadding="2">
		<tr align="center">
			<td width="12%"><b>Pencapaian (%)</b></td>
			<td width="8%"> 110 ></td>
			<td width="9%">110 >= x > 100</td>
			<td width="8%">100 >= x > 90</td>
			<td width="8%">90 >= x > 80</td>
			<td width="8%">80 >= x > 70</td>
			<td width="8%">70 >= x > 60</td>
			<td width="8%">60 >= x > 50</td>
			<td width="8%">50 >= x > 40</td>
			<td width="8%">40 >= x > 20</td>
			<td width="8%">20 >= x > 0</td>
			<td width="7%">0</td>
			';
	$isi .='</tr>
		<tr align="center">
