	...
	$isi ='
		...
		if($_GET['lvl']==4){
			$isi .='<th width="3%" ><b>No.</b></th>
					<th width="31%"><b>Rencana Kerja</b></th>
					<th width="11%"><b>Bobot Awal</b></th>
					<th width="11%"><b>Bobot</b></th>
					<th width="11%"><b>Target</b></th>
					<th width="11%"><b>Realisasi</b></th>
					<th width="11%"><b>Score</b></th>
					<th width="11%"><b>Bobot X Score</b></th>';
		}else{
			$isi .='<th width="3%" ><b>No.</b></th>
					<th width="31%"><b>Rencana Kerja</b></th>
					<th width="11%"><b>Bobot Awal</b></th>
