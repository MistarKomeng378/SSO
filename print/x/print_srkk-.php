...
set_time_limit(0);
	...
	$header1='
		...
		<table width="100%" border="1" cellpadding="3">
			<tr align="center">';
		if($_GET['lvl']==4){
			$header1 .='<th width="3%" rowspan="2"><b>No.</b></th>
					<th rowspan="2" width="15%"><b>Rencana Kerja</b></th>
					<th rowspan="2" width="5%"><b>Bobot Awal</b></th>
					<th rowspan="2" width="6%"><b>Bobot Konversi</b></th>
					<th rowspan="2" width="6%"><b>Target Tahunan</b></th>
					<th colspan="12" width="66%"><b>Target Bulanan</b></th>';
		}else{
			$header1 .='<th width="3%" rowspan="2"><b>No.</b></th>
					<th rowspan="2" width="21%"><b>Rencana Kerja</b></th>
					<th rowspan="2" width="5%"><b>Bobot</b></th>
					<th rowspan="2" width="6%"><b>Target Tahunan</b></th>
					<th colspan="12" width="65%"><b>Target Bulanan</b></th>';
		}
	$header1 .='</tr>
		<tr>';
		for($b=1;$b<=12;$b++){
			$header1 .='<th align="center"><b>'.$b.'</b></th>';
		}
	$header1 .='</tr></table>';
			...
			<tr>
				...
				<td width="40%" align="center">
					<b>
						...
						PERIODE :  Januari - Desember '.$tahun['tahun'].'
					</b>
				</td>
				<td width="30%"></td>
			</tr>
...
$isi .='<br>
	...
	$isi .='<tr>
				...
				<td align="center">'.desimal_float($r['bobot']).'</td>
				...
				for($b=1;$b<=12;$b++){
					...
					$bulanan = mysql_fetch_array(mysql_query("SELECT target FROM target_srko WHERE bulan='$b' AND tahun='$tahun[tahun]' AND id_srko='$r[id_srko]'"));
	...
	$isi .='</tr>';
		...
		$isi .='<tr>
				...
				for($b=1;$b<=12;$b++){	
					$bulanan	= mysql_fetch_array(mysql_query("SELECT * FROM srkk_bulanan WHERE bulan='$b' AND id_srkk='$r[id_srkk]' "));
					$isi .='<td  align="center">'.desimal_float($bulanan['target']).'</td>';
				}
		$isi .='
			</tr>';
			$no++;
...
class MYPDF extends TCPDF {
    ...
    public function Header() {
	   ...
	   // $this->writeHTML(($this->getPage()==1?$header2:''), true, false, true, false, '');
	}
...
$pdf->SetMargins(PDF_MARGIN_RIGHT, 20.5, PDF_MARGIN_RIGHT);
