    ...
    <body>
        <div class="container">
			<div class="box-body table-responsive">
				...
				<?php
					if(isset($_GET['cc'])){
						echo"<a href='cc2.php' class='btn btn-primary'><i class='glyphicon glyphicon-search'></i> Cost Center Divisi</a><hr>";
					}else{
						echo"<a href='cc2.php?cc=project' class='btn btn-primary'><i class='glyphicon glyphicon-search'></i> Cost Center Project</a><hr>";
					}
				?>
				...
				<table id="example1" class="table table-bordered table-striped table-hover">
					...
					<?php
						...
						if(isset($_GET['cc'])){
							...
							mysql_select_db($mysql_database2,$conn2) or die(include "../indexx.htm");
