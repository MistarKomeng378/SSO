					...
					<table border="0" width="100%">
						<tr> 
							...
							<td rowspan="2" align="right">
								<?php
									echo" <a href='print/print_penilaian_kerja_unit.php?CostCenter=".ec($getCc)."&tahun=".ec($getTahun)."' target='_blank' class='btn btn-primary'><i class='fa fa-print'></i> Cetak</a>";
								?> &nbsp;&nbsp;
							</td>
						</tr>
						<tr> 
						...
						<tr> 
							<td>Nilai</td>
							<td>:</td>
							<td><b><?=desimal3($jumlah_total_nilai)?></b></td>
						</tr>
					</table>
					<br>
