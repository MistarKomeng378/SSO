		...
		<table class="table table-bordered table-striped table-hover">
				...
				<tbody>
					<?php
						...
						while($r=mysql_fetch_array($query)){
							...
							echo"
								...
								<tr>
									...
									<td >
										<textarea  type='text' name='rencana_kerja[]' cols='100' rows='2' id='rencana_kerja' placeholder='rencana_kerja'>$r[rencana_kerja]</textarea> 
									</td>
									<td>
						...
						echo"
						<tr>
							<td align='right' colspan='3'><b>Total Bobot</b></td>
