<?php
$units = mysql_fetch_array(mysql_query("SELECT * FROM mskko WHERE CostCenter='".mysql_real_escape_string(dc($_GET['unit']))."'"));
...
?>		
		...
		<h1 class="page-header">Grafik Realisasi
		...
		<div class="panel panel-inverse">
			...
			<div class="panel-body">
				...
				$getCC			= mysql_real_escape_string($_POST['unit']);
					...
					echo"
				<form method='POST' action='page.php?page=grafik_realisasi' id='formku'>
