...
?>
		...
		<form method="POST" action="page/mod_target_srko/query_target.php">
					...
					<?php
						...
						while($r=mysql_fetch_array($query)){	
							...
							<tr>
								...
								<td ><font color='$font'>$r[rencana_kerja]</font></td>
								...
								for($i=1;$i<=12;$i++){
									...
									echo"<td>
											...
											<input type='hidden' name='parent_srko[]' value='$p_srko' size='5'>
			...
			<h6><b> -> Jika Tidak ada Target Sasaran Kerja pada bulan tertentu Harap Di ISI dengan Angka 0 (NOL)</b></h6>
			<h6><b> -> Pemisah angka desimal menggunakan tanda titik(.)</b></h6>
			<hr>
