...
for($i=0; $i<$jml; $i++){
	...
	if($bulan==1){
		...
		if($rumus==1){
			...
			@$prosen_real = (($rkap['target_rkap'] - ($realisasi-$rkap['target_rkap'])) / $rkap['target_rkap']) * 100;
		}		
...
for($i=0; $i<$jml2; $i++){
	...
	if($bulan==1){
		...
		if($rumus==1){
			...
			@$prosen_real = (($rkap['target_rkap'] - ($realisasi2-$rkap['target_rkap'])) / $rkap['target_rkap']) * 100;
		}		
