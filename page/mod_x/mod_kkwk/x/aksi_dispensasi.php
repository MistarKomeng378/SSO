			...
			if($overtime > 24){
				...
				if(empty($fileName)){
					...
					if($cek_progress['maxpro']==100 OR $cek_progress['jenisAktf']==2){
						echo"<SCRIPT language='javascript'>alert('KKWK tidak dapat digunakan, Progress GCA sudah 100% ...!!');document.location='../../page.php?page=dispensasi_kkwk'</SCRIPT>";
					}else{
						...
						timeline($nik,"tambah","pembuatan dispensasi KKWK pada jam $jam_m dengan ID_GCA $jo_gca -> $aktifitas");
