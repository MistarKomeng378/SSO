				...
				// if($_SESSION['level']!=5 AND $_SESSION['level']!=4){	
					echo"<div class='form-group  col-lg-3'>
						<div class='input-group input-group'>
							<input type='text' name='unit' class='form-control' value='$_POST[unit]' id='cc' placeholder='Kode Proyek / Cost Center'>
					...
					<div class='form-group  col-lg-2'>
						<div class='input-group input-group'>
							<input type='text' name='nik' class='form-control' value='$_POST[nik]' placeholder='NIK' id='nik'>
							<span class='input-group-btn'>
						...
						while($r=mysql_fetch_array($query)){
							...
							echo"
								<tr>
									...
									<td><a href='#modal-message' class='edit-record btn btn-xs btn-primary' data-id='$_POST[bulan]-$_POST[tahun]-$_POST[unit]-$r[nik]' data-toggle='modal'>Show</a></td>
								</tr>
							";
						$no++;
						$jum_jam =0;
