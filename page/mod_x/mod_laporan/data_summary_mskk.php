		...
		echo"<form method='POST' action='page.php?page=summary_mskk' id='formku'>
				<div class='form-group  col-lg-12 row'>
					...
					<div class='form-group  col-lg-1'>
						<input type='text' name='tahun' class='form-control required' value='".$thMSKK."' placeholder='Tahun'>
					</div>";
							...
							echo"
								<tr>
									...
									for($i=1;$i<=12;$i++){
										...
										echo"<td align='center'><a href='#modal-message' class='edit-record ' data-id='$i-$getTahun-$getUnit-$r[nik]' data-toggle='modal'>".desimal($JmlMskk['bxs'])."</a></td>";
										$totalMSKK += $JmlMskk['bxs'];
									}
									$avgMSKK = $totalMSKK/12;
									echo"<td>".desimal($avgMSKK)."</td>";
						$no++;
						$totalMSKK = 0;
						echo"<tr>";
						}
								...
								echo"
									<tr>
										...
										for($i=1;$i<=12;$i++){
											...
											echo"<td align='center'><a href='#modal-message' class='edit-record ' data-id='$i-$getTahun-$getUnit-$r2[nik]' data-toggle='modal'>".desimal($JmlMskk['bxs'])."</a></td>";
											$totalMSKK += $JmlMskk['bxs'];
										}
										$avgMSKK = $totalMSKK/12;
										echo"<td>".desimal($avgMSKK)."</td>";
