...
include"../../config/fungsi_rupiah.php";
	...
	$queryKaryawan	= mysql_query("SELECT nik,level FROM user WHERE  grup_id='$id' AND nik='$getNik' ");
		...
		if($r['level']!=4){
			...
			while($r2=mysql_fetch_array($querySRKK)){
				...
				$lv1 = mysql_query("SELECT id,pic,cc_id FROM wbs WHERE parentId='$r2[id_gca]' ");
						...
						while($w0=mysql_fetch_array($wk0)){
							$durasi0	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r2[id_gca]' AND nik='$r[nik]' AND bulan='$w0[bulan]' AND tahun='$tahun_aktif'"));
				...
				while($r3=mysql_fetch_array($lv1)){
					if($r3['pic']==$r['nik']){
						...
						while($w=mysql_fetch_array($wk)){
							$durasi1	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r3[id]' AND nik='$r[nik]' AND bulan='$w[bulan]' AND tahun='$tahun_aktif'"));
							...
							// echo"LV1 $w[bulan] $durasi1[jum]<br>";
						}
						$sd1	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r3[id]' AND nik='$r[nik]' AND tahun='$tahun_aktif'"));
					...
					while($r4=mysql_fetch_array($lv2)){
						if($r4['pic']==$r['nik']){
							...
							while($w2=mysql_fetch_array($wk2)){
								$durasi2	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r4[id]' AND nik='$r[nik]' AND bulan='$w2[bulan]' AND tahun='$tahun_aktif'"));
								...
								// echo"LV2 $w2[bulan] $durasi2[jum]<br>";
							}
							$sd2		= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r4[id]' AND nik='$r[nik]' AND tahun='$tahun_aktif'"));
						...
						while($r5=mysql_fetch_array($lv3)){
							if($r5['pic']==$r['nik']){
								...
								while($w3=mysql_fetch_array($wk3)){
									$durasi3	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r5[id]' AND nik='$r[nik]' AND bulan='$w3[bulan]' AND tahun='$tahun_aktif'"));
									...
									// echo"LV3 $w3[bulan] $durasi3[jum]<br>";
								}
								$sd3		= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r5[id]' AND nik='$r[nik]' AND tahun='$tahun_aktif'"));
							...
							while($r6=mysql_fetch_array($lv4)){
								if($r6['pic']==$r['nik']){
									...
									while($w4=mysql_fetch_array($wk4)){
										$durasi4	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r6[id]' AND nik='$r[nik]' AND bulan='$w4[bulan]' AND tahun='$tahun_aktif'"));
										...
										// echo"LV4 $w4[bulan] $durasi4[jum]<br>";
									}
									$sd4		= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r6[id]' AND nik='$r[nik]' AND tahun='$tahun_aktif'"));
								...
								while($r7=mysql_fetch_array($lv5)){
									if($r7['pic']==$r['nik']){
										...
										while($w5=mysql_fetch_array($wk5)){
											$durasi5	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r7[id]' AND nik='$r[nik]' AND bulan='$w5[bulan]' AND tahun='$tahun_aktif'"));
											...
											// echo"LV5 $w5[bulan] $durasi5[jum]<br>";
										}
										$sd5		= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r7[id]' AND nik='$r[nik]' AND tahun='$tahun_aktif'"));
									...
									while($r8=mysql_fetch_array($lv6)){
										if($r8['pic']==$r['nik']){
											...
											while($w6=mysql_fetch_array($wk6)){
												$durasi6	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r8[id]' AND nik='$r[nik]' AND bulan='$w6[bulan]' AND tahun='$tahun_aktif'"));
												...
												// echo"LV6 $w6[bulan] $durasi6[jum]<br>";
											}
											$sd6		= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r8[id]' AND nik='$r[nik]' AND tahun='$tahun_aktif'"));
			...
			while($sr=mysql_fetch_array($querySRKK2)){
				...
				while($bln=mysql_fetch_array($tbln)){
					...
					// echo"-->$bln[target]*100/$jmlTarget[nilai]= $prosen<br>";
				}
				// echo"Total = $jmlTarget[nilai]<br>";
			}
		}		
	}
	header('Location: ../../page.php?page=detail_srkk&nik='.ec($getNik).'&succes=1');
?>