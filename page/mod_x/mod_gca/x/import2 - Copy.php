...
//       membaca data (kolom ke-1 sd terakhir)
		...
		foreach ($period1 as $dt1) {
			...
			$bln 		= $dt1->format("m");
			// echo"$bln<br>";
			mysql_query("REPLACE INTO waktu_kerja2(`nik`,`id_gca`,`bulan`,`tahun`) VALUES('$pic','$id','$bln','$thn') ");
		}
		/////////////////////////////////////////////////////////////////////////////////////////
		...
		foreach ($period as $dt) {
			...
			for ($tgl=1;$tgl<=$lastDay;$tgl++){
				...
				if($jam_kerja !=0){
					mysql_query("UPDATE waktu_kerja2 SET  `$tgl`='$jam_kerja' WHERE `nik`='$pic' AND `id_gca`='$id' AND bulan='$month' AND tahun='$year'");
...
/////////////////////////////////////////////////////////////////////////////////////////
		...
		// }
///////////////////////////////////////////////////////////////////////////////////////
      $query = "REPLACE INTO wbs(`id`, `parentId`, `id_srko`, `aktivitas`, `mulai`, `akhir`, `cc`, `pic`, `deliverable`, `bobot`, `kode_kpi`, `jam`, `tgl_isi`, `gca_by`, `tahun`, `durasi`) 
