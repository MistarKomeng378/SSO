        ...
        <div class="box-body ">
			<div class="form-group">
                <label for="submenu">Nama Submenu</label>
                    <input type="hidden" class="form-control required" name="id" placeholder="id" value="<?=$id?>" >
                    <input type="hidden" class="form-control required" name="parentId" placeholder="parentId" value="<?=$parentId?>" >
