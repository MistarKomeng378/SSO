					...
					<tbody>
						<?php
							...
							while($r=mysql_fetch_array($query)){
								// Jumlah Hari Kerja
								$hk 	= mysql_fetch_array(mysql_query("SELECT SUM(hk) as h_kerja FROM anggota where nik='$r[nik]' AND tahun='$getTahun' AND bulan='$getBulan'"));
