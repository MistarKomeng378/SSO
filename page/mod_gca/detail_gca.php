...
if($_SESSION['level']==1){
	...
	echo"
		...
		<a href='page/mod_gca/destroy_gca.php?opt=delete&id=".ec($id)."-".ec($_SESSION['nik'])."&aktv=".$data['aktivitas']."' class='btn btn-sm btn-danger' onClick=\"return confirm('Yakin Hapus Data?')\"><i class='fa fa-remove'></i> Hapus</a>
