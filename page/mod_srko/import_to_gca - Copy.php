<h1 class="page-header">Import SRKO Ke GCA
	...
	<h5><b>DIVISI > KPM >  RENCANA KERJA</b></h5><hr>
	<form method="POST" action="page/mod_srko/aksi_import_gca.php">
		...
		while($r=mysql_fetch_array($query)){
			...
			echo"<input type='hidden' name='cc_div[]' value='$r[CostCenter]' size='5'>";
			...
			$kpm = mysql_query("SELECT distinct kpm,id_kpi,CostCenter,hasil_akhir FROM srko WHERE CostCenter='$r[CostCenter]' AND tahun='$tahun_aktif'");
			...
			while($k=mysql_fetch_array($kpm)){
				...
				echo"<li>
						...
						<input type='text' name='aktivitas_kpm[]' value='$k[kpm]' size='75' class='form-control'>
						";
					echo"<ul>";
