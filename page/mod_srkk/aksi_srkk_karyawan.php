...
include"../../config/fungsi_rupiah.php";
	...
	$thSRKK			= mysql_real_escape_string(dc($ex[3]));
			...
			while($r2=mysql_fetch_array($querySRKK)){
				...
				$lv1 = mysql_query("SELECT id,pic,cc_id FROM wbs WHERE parentId='$r2[id_gca]' AND tahun='$thSRKK'");
						...
						while($w0=mysql_fetch_array($wk0)){
							$durasi0	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r2[id_gca]' AND nik='$r[nik]' AND bulan='$w0[bulan]' AND tahun='$thSRKK'"));
				...
				while($r3=mysql_fetch_array($lv1)){
					if($r3['pic']==$r['nik']){
						...
						while($w=mysql_fetch_array($wk)){
							$durasi1	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r3[id]' AND nik='$r[nik]' AND bulan='$w[bulan]' AND tahun='$thSRKK'"));
						...
						$sd1	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r3[id]' AND nik='$r[nik]' AND tahun='$thSRKK'"));
					...
					while($r4=mysql_fetch_array($lv2)){
						if($r4['pic']==$r['nik']){
							...
							while($w2=mysql_fetch_array($wk2)){
								$durasi2	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r4[id]' AND nik='$r[nik]' AND bulan='$w2[bulan]' AND tahun='$thSRKK'"));
							...
							$sd2		= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r4[id]' AND nik='$r[nik]' AND tahun='$thSRKK'"));
						...
						while($r5=mysql_fetch_array($lv3)){
							if($r5['pic']==$r['nik']){
								...
								while($w3=mysql_fetch_array($wk3)){
									$durasi3	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r5[id]' AND nik='$r[nik]' AND bulan='$w3[bulan]' AND tahun='$thSRKK'"));
								...
								$sd3		= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r5[id]' AND nik='$r[nik]' AND tahun='$thSRKK'"));
							...
							while($r6=mysql_fetch_array($lv4)){
								if($r6['pic']==$r['nik']){
									...
									while($w4=mysql_fetch_array($wk4)){
										$durasi4	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r6[id]' AND nik='$r[nik]' AND bulan='$w4[bulan]' AND tahun='$thSRKK'"));
									...
									$sd4		= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r6[id]' AND nik='$r[nik]' AND tahun='$thSRKK'"));
								...
								while($r7=mysql_fetch_array($lv5)){
									if($r7['pic']==$r['nik']){
										...
										while($w5=mysql_fetch_array($wk5)){
											$durasi5	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r7[id]' AND nik='$r[nik]' AND bulan='$w5[bulan]' AND tahun='$thSRKK'"));
										...
										$sd5		= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r7[id]' AND nik='$r[nik]' AND tahun='$thSRKK'"));
									...
									while($r8=mysql_fetch_array($lv6)){
										if($r8['pic']==$r['nik']){
											...
											while($w6=mysql_fetch_array($wk6)){
												$durasi6	= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r8[id]' AND nik='$r[nik]' AND bulan='$w6[bulan]' AND tahun='$thSRKK'"));
											...
											$sd6		= mysql_fetch_array(mysql_query("SELECT SUM(total_jam) as jum FROM waktu_kerja2 WHERE id_gca='$r8[id]' AND nik='$r[nik]' AND tahun='$thSRKK'"));
	...
	header('Location: ../../page.php?page=detail_srkk&id='.ec($getNik).'-'.ec($thSRKK).'&succes=1');
?>