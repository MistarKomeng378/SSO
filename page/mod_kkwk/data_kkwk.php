<h1 class="page-header">Catatan Kerja dan Hasil Kerja
	...
	<div class="panel panel-inverse">
		...
		<?php
			if($getInsert==1){
				echo"
					<a href='?page=form_kkwk&opt=tambah' class='btn btn-primary'><i class='fa fa-plus'></i> Isi KKWK</a> 
					<a href='?page=form_kkwk2&opt=pilih' class='btn btn-primary'><i class='fa fa-plus'></i> Isi KKWK2</a>
					";
				echo"
